...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const currentExpTimeElements = document.querySelectorAll(".current-exp-time");
  if (currentExpTimeElements) {
    currentExpTimeElements.forEach((el) => (el.textContent = formatExperienceTime(diffInMonths)));
  }
});
